...
INSERT INTO `fos_user` VALUES (1,'admin@admin.com','admin@admin.com','admin@admin.com','admin@admin.com',1,'dju24fp08oowo80gocc0k488ocs4w4c','odgAycgDmQMgOVnwmqbaLYoOfnSa/UCfrTi1DXvIdCBDBlK6NRwSdyKqwbPfwJJWnHgG70ilyv8BLB3mQ+y7CQ==','2014-04-09 22:16:59',0,0,NULL,NULL,NULL,'a:1:{i:0;s:10:\"ROLE_ADMIN\";}',0,NULL);
...
CREATE TABLE `ns_catalog_catalogs` (
  ...
  `settingsFormTypeName` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `settingsModelClassName` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ns_catalog_categories` (
  ...
  KEY `IDX_649E8DF2C54C8C93` (`type_id`),
  CONSTRAINT `FK_649E8DF2C54C8C93` FOREIGN KEY (`type_id`) REFERENCES `ns_catalog_types` (`id`),
...
INSERT INTO `ns_catalog_categories` VALUES (1,NULL,NULL,1,0,14,1,'ns_catalog_categories_root_category','ns_catalog_categories_root_category','ns-catalog-categories-root-category',NULL,NULL,NULL),(2,1,1,2,1,3,1,'Осетинские пироги',NULL,'osietinskiie-piroghi',NULL,NULL,NULL),(3,1,1,4,1,5,1,'Сладкие пироги',NULL,'sladkiie-piroghi',NULL,NULL,NULL),(4,1,1,6,1,7,1,'Торты и десерты',NULL,'torty-i-diesierty',NULL,NULL,NULL),(5,1,1,8,1,9,1,'Кулинария',NULL,'kulinariia',NULL,NULL,NULL),(6,1,1,10,1,11,1,'Салаты',NULL,'salaty',NULL,NULL,NULL),(7,1,1,12,1,13,1,'Напитки',NULL,'napitki',NULL,NULL,NULL);
...
CREATE TABLE `ns_catalog_types` (
  ...
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `adminViewportConfig` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '(DC2Type:json_array)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ns_cms_pages` VALUES (1,NULL,1,0,22,1,'ns_cms_pages_root_page','ns_cms_pages_root_page',NULL,0,1),(2,1,2,1,9,1,'Главная','main','NSCmsBundle:Pages:page_index.html.twig',0,0),(3,1,10,1,11,1,'О компании','about','NSCmsBundle:Pages:page_static.html.twig',1,1),(4,1,12,1,13,1,'Оплата и доставка','payment-delivery','NSCmsBundle:Pages:page_static.html.twig',2,1),(5,1,14,1,15,1,'Контакты','contacts','NSCmsBundle:Pages:page_contacts.html.twig',3,1),(6,1,16,1,17,1,'Организация выездных банкетов','bankety','NSCmsBundle:Pages:page_static.html.twig',4,1),(8,2,3,2,8,1,'Каталог','catalog',NULL,0,1),(9,8,4,3,5,1,'Наше меню','item',NULL,0,0),(10,8,6,3,7,1,'Наше меню','category','NSCmsBundle:Pages:page.html.twig',1,1),(11,1,18,1,19,1,'Корзина','cart','NSCmsBundle:Pages:page.html.twig',5,0),(12,1,20,1,21,1,'Оформление заказа','checkout','NSCmsBundle:Pages:page.html.twig',6,0);
...
-- Dump completed on 2014-04-12 21:52:49
